...
export default function Step1Content({ running, customUrl, apiUrl, apiResult, onStart, onStop,
  onNavigate, onCustomUrl, setCustomUrl, onRefresh, onSaveCookies, onLoadCookies, onApiRequest, setApiUrl }: {
  running: boolean; customUrl: string; apiUrl: string; apiResult: string | null
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <div style={{ display: 'flex', gap: 6 }}>
        <button className="btn-click" onClick={onStart} disabled={running} style={{
        ...
        <button className="btn-click" onClick={onStop} disabled={!running} style={{
