...
_xiaoyuan: Optional[SeleniumXiaoYuan] = None


def _get_xiaoyuan() -> SeleniumXiaoYuan:
    global _driver, _xiaoyuan
    if _xiaoyuan is None:
        ...
        _xiaoyuan = SeleniumXiaoYuan(_driver.driver)
        time.sleep(random.randint(2, 5))
        atexit.register(lambda: _driver.close_browser())  # 使用封装的方法
    return _xiaoyuan
...
def get_task_cards(keyword: str = "单题标答-审核") -> str:
    ...
    """
    xy = _get_xiaoyuan()
    title_cards = xy.home(like=keyword)
