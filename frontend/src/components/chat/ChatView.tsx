...
export default function ChatView({ messages, loading, user, setExpandedImage, input, setInput, handleSend, images, setImages, model, setModel, currentSid, sidebarOpen, setSidebarOpen, sessions, panel, setPanel }: {
